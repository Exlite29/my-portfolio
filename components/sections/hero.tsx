...
// const myCv = '/assets/MyCv.pdf';

// function Hero() {

//     const handleDownloadCv = async () => {
//         try {
//             // Verify file existence (in development)
//             if (process.env.NODE_ENV === 'development') {
//                 const fileExists = await fetch(myCv).then(res => res.ok);
//                 if (!fileExists) {
...
function Hero() {
    ...
    // Alternative method using fetch (if you need to verify first)
    // const handleDownloadCvWithVerification = async () => {
    //     try {
    //         const response = await fetch('/assets/MyCv.pdf')
    //         if (!response.ok) {
    //             throw new Error('CV file not found')
    //         }
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                ...
                                <motion.button
                                    onClick={handleDownloadCv} // or handleDownloadCvWithVerification
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className="px-6 py-3 bg-[#393E46] text-white font-bold rounded-3xl flex items-center gap-2 shadow-lg hover:bg-[#2C3136] transition-all duration-300"
                                >
